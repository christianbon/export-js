...
const url = 'https://assessment-alta-prod.as.r.appspot.com/api/users/' + sessionStorage.getItem("userId") + '?populate[client_profile][populate]=%2A';
const savedBookmarkUrl = 'https://assessment-alta-prod.as.r.appspot.com/api/users?'
const getBookmarkURL = new URL('https://assessment-alta-prod.as.r.appspot.com/api/bookmarks?filters[clientId][$eq]=');
const updateUrl = 'https://assessment-alta-prod.as.r.appspot.com/api/users/'
